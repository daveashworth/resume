...
\documentclass[letterpaper,11pt]{article}
  ...
  \section{Experience}
    ...
    \resumeSubheading
        ...
        \resumeItemListStart
            \resumeItem
                {Designed and implemented a customer database using Planetscale, automating the import of customer data and rewards points integration with Alle. Developed an SMS notification system alerting customers of expiring rewards with booking links, improving engagement.}
            \resumeItem
                {Initiated development of a React Native app for providers documenting procedures (e.g., Botox, fillers) but paused the project due to funding limitations.}
            \resumeItem
